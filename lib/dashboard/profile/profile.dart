              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    title:  Text('Student ID: ${state.student.studentId ?? ''}',
                      style: const TextStyle(fontWeight: FontWeight.normal),
                    ),
                    // trailing: Icon(Icons.person_outlined),
                  ),
                  ...
                  ListTile(
                    leading: const Icon(Icons.home_repair_service),
                    title: Text( state.student.dreamJob =='' ? 'Set Your Dream Job' : 'Your Dream Job: ${state.student.dreamJob}',
                      style: const TextStyle(fontWeight: FontWeight.normal),
                    ),
                     trailing: const Icon(Icons.edit),
                  ),
                  ...
                  const SizedBox(
                    ...
                    Padding(
                      ...
                      child: LongButton(
                        color: Colors.red,
                        onPressed: () {
                          context.read<ProfileCubit>().updateSinglePropertyOnState('isLoading', true);
